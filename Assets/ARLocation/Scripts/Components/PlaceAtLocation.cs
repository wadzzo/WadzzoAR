...
namespace ARLocation
{
    ...
    public class PlaceAtLocation : MonoBehaviour
    {
        ...
        public static GameObject CreatePlacedInstance(GameObject go, Location location, PlaceAtOptions options, bool useDebugMode = false)
        {
            ...
            instance.tag = "MapPin";
            instance.GetComponentInChildren<ARItem>().ARuser = LocationDataManager.UserLocation.locations[PlaceAtLocations.UsersCounter];
            instance.GetComponentInChildren<ARItem>().Init(LocationDataManager.UserLocation.locations[PlaceAtLocations.UsersCounter]);

            Debug.Log("<ARItem>().ARuser "+ instance.GetComponentInChildren<ARItem>().ARuser.id);
            Debug.Log("PlaceAtLocations.UsersCounter " + LocationDataManager.instance.users[PlaceAtLocations.UsersCounter].id);
